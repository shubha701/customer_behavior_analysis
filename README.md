...
Created a professional project presentation using Gamma AI covering:
...
* Identified major trends and patterns within the dataset.
* Detected key factors influencing business performance.
...
1. Import cleaned dataset into PostgreSQL/MySQL/SQL Server.
2. Execute SQL scripts from the `sql` folder.
3. Validate outputs and KPIs.
...
* Practical experience with Python, SQL, and Power BI.
